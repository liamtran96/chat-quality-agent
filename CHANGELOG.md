...
### Sửa lỗi
- **Cuộc chat cũ bị đánh giá lại mỗi ngày**: một cuộc chat kết thúc từ 02/07 có tới 41 bản đánh giá. Gốc là mốc quét của công việc chạy theo lịch bị đóng băng ở thời điểm ứng dụng khởi động — bản sao công việc nạp lúc đăng ký lịch không bao giờ đọc lại `last_run_at` mới, nên mỗi sáng job quét lại toàn bộ hội thoại kể từ lần khởi động gần nhất (5.143 cuộc chat), chạy đủ 30 phút thì bị cắt sau khoảng 400 cuộc. Không có thứ tự quét cố định lẫn điều kiện bỏ qua cuộc đã đánh giá nên ngày nào cũng lặp lại đúng nhóm cũ nhất: 87% cuộc chat trong 30 ngày gần nhất chưa từng được đánh giá, tiền AI đổ vào việc chấm lại. Nay mỗi lượt chạy đọc lại công việc từ database, quét từ cũ đến mới, bỏ qua cuộc chat đã có đánh giá mới hơn tin nhắn cuối, và lượt chạy bị cắt vì hết giờ được ghi trạng thái `partial` đồng thời giữ nguyên mốc quét để phần còn lại vào lần sau
